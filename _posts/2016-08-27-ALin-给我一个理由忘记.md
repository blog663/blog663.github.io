...
<head>
<meta charset="UTF-8">
<title>听松阁音乐播放器</title>
<link rel='stylesheet' href='{{ site.baseurl }}/assets/music/css/jquery-ui.css'>
<style>

body { background: url({{ site.baseurl }}/assets/music/css/006.jpg) }
...
.music-player > .dash
{
  ...
  left: 0;
  height: 300px;
  background: url(css/image_png_00001.png) center bottom repeat-x;
}
...
.music-player > .dash > .seeker > .wheel > .progress
{
  ...
  background: url(css/image_png_00003.png);
...
<div class="music-player">
  <img src="css/wh8.jpg" class="album" />
  <div class="dash">
	...
	<audio controls autoplay loop>
        <source src="https://pan.111.gs/free163person/ALin-%E6%9C%89%E4%B8%80%E7%A7%8D%E6%82%B2%E4%BC%A4.mp3" type="audio/mpeg">
    </audio>
	</div>
    <div class="info">
